...
// Import bundled documents
import simpleLayout from '../../assets/documents/simple-layout.json';
import twoColumn from '../../assets/documents/two-column.json';
import complexLayout from '../../assets/documents/complex-layout.json';
